    ...
    @section('content')
        <header id="topbar">
            ...
            <div class="topbar-right">
                <a href="{{ url('admin/vehicle/add') }}" class="btn btn-default btn-sm light fw600 ml10">
                    ...
                    <div class="panel panel-visible" id="spy3">
                        <div class="panel-heading">
                            <div class="panel-title hidden-xs">
                                <span class="glyphicon glyphicon-tasks"></span>Vehicle
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-hover" id="datatable" cellspacing="0" width="100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ url('admin/vehicle/add') }}/{{ $post->id }}"
...
<script>
    function deleteConfirmation(id) {
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    window.location.href = "{{ url('admin/vehicle/delete') }}" + '/' + id;
                } else {
                    swal({
                        title: "Cancelled",
