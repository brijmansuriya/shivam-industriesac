    ...
    @section('content')
        <header id="topbar">
            ...
            <div class="topbar-right">
                <a href="{{ url('admin/category/add') }}" class="btn btn-default btn-sm light fw600 ml10">
                    ...
                    <div class="panel panel-visible" id="spy3">
                        <div class="panel-heading">
                            <div class="panel-title hidden-xs">
                                <span class="glyphicon glyphicon-tasks"></span>Country
                            </div>
                        </div>
                            ...
                            <table class="table table-striped table-hover" id="datatable" cellspacing="0" width="100%">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ url('admin/category/add') }}/{{ $post->id }}"
